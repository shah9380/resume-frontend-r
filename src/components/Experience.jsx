    ...
    <section>
        ...
        <div className='py-2'>
            <div className='flex justify-between items-center'>
                <h6 className='text-md font-medium'>TATA Consultancy Services Ltd</h6>
                <small className='text-sm font-medium md:mr-24'><span className='mr-1'>&#91;</span>Dec/2021 - Present<span className='ml-1'>&#93;</span></small>
            </div>
